...
root_dir = Path("/path/to/03_image_analysis/07_conditioned_medium/02_data/img/cp")
output_csv = Path("/path/to/03_image_analysis/07_conditioned_medium/02_data/tables/cell_analysis.csv")
